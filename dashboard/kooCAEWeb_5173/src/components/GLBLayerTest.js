...
const GLBLayerTest = ({ glbUrl, glbFile, onBounds }) => {
    ...
    useEffect(() => {
        ...
        BABYLON.SceneLoader.ImportMesh(null, "", urlToLoad, scene, (meshes) => {
            ...
            const hullPointsObj = concave.map((p) => ({ x: p[0], y: p[1] }));
    ...
    return (_jsx(Layer, { listening: false, children: _jsx(Line, { points: points, closed: true, fill: "green", stroke: "none", strokeWidth: 0, perfectDrawEnabled: false, listening: false }) }));
};
