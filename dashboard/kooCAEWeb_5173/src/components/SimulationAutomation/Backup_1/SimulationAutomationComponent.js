...
const SimulationAutomationComponent = () => {
    ...
    const renderCumControls = (row) => {
        ...
        return (_jsxs(Flex, { vertical: true, gap: 10, children: [_jsx("style", { children: `
    ...
    const renderOptionControls = (row) => {
        ...
        return (_jsxs(Flex, { gap: 12, align: "center", wrap: true, style: { alignItems: "flex-start" }, children: [_jsxs(Radio.Group, { size: "small", value: mode, onChange: (e) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), piMode: e.target.value } } : r)), children: [_jsx(Radio, { value: "default", children: "default (\uC790\uB3D9 \uC120\uD0DD)" }), _jsx(Radio, { value: "txt", children: "txt \uC5C5\uB85C\uB4DC (\uD328\uD0A4\uC9C0 \uC774\uB984)" })] }), mode === "txt" && (_jsxs(_Fragment, { children: [_jsx(Upload, { ...uploadPropsPI, children: _jsx(Button, { size: "small", icon: _jsx(UploadOutlined, {}), children: "txt \uC120\uD0DD" }) }), fileName && _jsx(Tag, { color: "geekblue", children: fileName })] }))] }));
    };
        ...
        },
        {
            ...
            render: (_, row) => (_jsx(Select, { style: { width: "100%" }, size: "small", value: row.analysisType, onChange: (v) => {
                    setScenarios((prev) => prev.map((r) => (r.id === row.id ? {
                        ...r,
                        analysisType: v,
                        params: v === "fullAngleMBD" ? { mbdCount: 1000, angleSource: "lhs" } :
    ...
    const handleBulkSetType = () => {
        ...
        setScenarios((prev) => prev.map((r) => selectedRowKeys.includes(r.id) ? {
            ...
            params: bulkType === "fullAngleMBD" ? { mbdCount: 1000, angleSource: "lhs" } :
