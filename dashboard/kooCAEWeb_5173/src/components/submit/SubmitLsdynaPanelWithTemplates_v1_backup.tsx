    ...
    <div>
      ...
      >
        ...
        >
          ...
          <ApptainerTemplateIntegration
            ...
            applyButtonText="Apply Template to Jobs"
            showPreview={true}
          />
          ...
          {selectedTemplate && (
            <div style={{ marginTop: 24 }}>
              <h3>Upload K Files for Template-Based Submission</h3>
              <p style={{ color: '#666', marginBottom: 16 }}>
                Template: <strong>{selectedTemplate.display_name}</strong>
      ...
      {selectedTemplate && activeTab === 'upload' && (
        <div style={{
          ...
          <strong>Active Template:</strong> {selectedTemplate.display_name}
