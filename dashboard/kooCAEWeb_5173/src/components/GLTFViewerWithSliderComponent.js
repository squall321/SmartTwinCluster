...
const GltfViewerWithSliderComponent = ({ url }) => {
    ...
    return (_jsxs("div", { style: { width: '100%', height: '700px', position: 'relative' }, children: [loading && (_jsx("div", { style: {
                ...
                }, children: "Loading..." })), _jsx("canvas", { ref: canvasRef, style: { width: '100%', height: '600px', display: 'block' } }), _jsxs("div", { style: { padding: '12px 24px' }, children: [_jsx(Slider, { min: frameRange[0], max: frameRange[1], value: currentFrame, onChange: onSliderChange, disabled: loading }), _jsx(Button, { onClick: togglePlay, style: { marginTop: 12 }, children: isPlaying ? '⏸ Pause' : '▶ Play' })] })] }));
};
