 ...
 */
export function memory_to_kb(memoryStr: string): number {
 ...
 */
export function time_to_seconds(timeStr: string): number {
  // Format: DD-HH:MM:SS
 ...
 */
export function filename_without_ext(path: string): string {
...
const TRANSFORM_FUNCTIONS: Record<string, (value: any) => any> = {
  memory_to_kb,
  time_to_seconds,
  basename,
  dirname,
 ...
 */
function resolveComputedVariable(
  source: string,
  transform: string,
