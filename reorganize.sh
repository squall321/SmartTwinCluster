...
echo ""
echo "4. 설정 파일 준비"
echo -e "   ${YELLOW}cp examples/2node_example.yaml my_multihead_cluster.yaml${NC}"
echo -e "   ${YELLOW}vim my_multihead_cluster.yaml${NC}"
echo ""
echo "5. Slurm 설치 시작"
...
echo "   • 설정 파일 검증: ./validate_config.py my_multihead_cluster.yaml"
echo "   • SSH 연결 테스트: ./test_connection.py my_multihead_cluster.yaml"
echo ""
