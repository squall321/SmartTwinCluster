...
function getDagreLayout(nodes, edges, direction) {
...
function getHierarchicalLayout(nodes, edges, direction) {
...
// 🌐 Clustered Layout
function getClusteredLayout(nodes, edges, direction) {
...
function getForceDirectedLayout(nodes, edges, direction) {
...
function getSourcePosition(direction) {
    switch (direction) {
...
function getTargetPosition(direction) {
    switch (direction) {
        case 'TB': return 'top';
...
export function centerGraph(nodes) {
    if (nodes.length === 0)
        return nodes;
...
export function getOptimalSpacing(nodeCount) {
    if (nodeCount < 10) {
