...
const analysisLabel = (row) => {
    if (row.analysisType === "fullAngle") {
        if (row.params?.angleSource === "preFA" || row.params?.angleSource === "fromFA")
            return "전각도 누적 낙하";
        return "전각도 낙하";
    }
...
const SimulationAutomationComponent = () => {
        ...
        onChange: () => {
            ...
            if (sel) {
                ...
                const newRows = objFileBufferRef.current.map((f) => ({
                    ...
                    params: { mbdCount: 1000, angleSource: "lhs", heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" },
                }));
        ...
        onChange: () => {
            ...
            if (sel) {
                ...
                const newRows = kFileBufferRef.current.map((f) => ({
                    ...
                    params: { faTotal: 100, includeFace6: true, includeEdge12: true, includeCorner8: true, angleSource: "lhs", preMbdCount: 10000, preFaTotal: 100, heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" },
                }));
                setScenarios(prev => [...prev, ...newRows]);
    ...
    const renderCumControls = (row) => {
        ...
        return (_jsxs(Flex, { vertical: true, gap: 10, children: [renderCommonDropControls(row, setScenarios), _jsx("style", { children: `
    ...
    const renderOptionControls = (row) => {
        ...
        if (row.analysisType === "fullAngle") {
            ...
            return (_jsxs(Flex, { gap: 10, align: "center", wrap: true, style: { alignItems: "flex-start" }, children: [renderCommonDropControls(row, setScenarios), _jsx(Divider, { type: "vertical" }), _jsx(Text, { children: "\uCD1D \uAC1C\uC218" }), _jsx(Select, { style: { width: 120 }, value: total, options: FULL_ANGLE_COUNTS.map(v => ({ label: v.toString(), value: v })), onChange: (v) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), faTotal: v } } : r)), size: "small" }), _jsx(Divider, { type: "vertical" }), _jsxs(Space, { size: 8, wrap: true, children: [_jsxs("span", { children: [_jsx(Switch, { size: "small", checked: face, onChange: (val) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), includeFace6: val } } : r)) }), " \uBA74(+6)"] }), _jsxs("span", { children: [_jsx(Switch, { size: "small", checked: edge, onChange: (val) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), includeEdge12: val } } : r)) }), " \uC5E3\uC9C0(+12)"] }), _jsxs("span", { children: [_jsx(Switch, { size: "small", checked: corner, onChange: (val) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), includeCorner8: val } } : r)) }), " \uCF54\uB108(+8)"] })] }), remainingTag, _jsx(Divider, { type: "vertical" }), _jsx(Text, { children: "\uAC01\uB3C4 \uC120\uD0DD" }), _jsxs(Radio.Group, { size: "small", value: angleSource, onChange: (e) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), angleSource: e.target.value } } : r)), children: [_jsx(Radio, { value: "lhs", children: "LHS(\uAE30\uBCF8)" }), _jsx(Radio, { value: "preMBD", children: "MBD \uC804\uCC98\uB9AC \uC2E4\uD589" }), _jsx(Radio, { value: "fromMBD", children: "\uAE30\uC874 MBD \uACB0\uACFC \uC0AC\uC6A9" }), _jsx(Radio, { value: "preFA", children: "FA \uC804\uCC98\uB9AC \uC2E4\uD589" }), _jsx(Radio, { value: "fromFA", children: "\uAE30\uC874 FA \uACB0\uACFC \uC0AC\uC6A9" })] }), angleSource === "preMBD" && (_jsxs(Space, { size: 8, wrap: true, children: [_jsx(Text, { type: "secondary", children: "\uC804\uCC98\uB9AC MBD \uC0D8\uD50C" }), _jsx(Select, { style: { width: 160 }, value: preMbdCount, options: MBD_COUNTS.map(v => ({ label: v.toLocaleString(), value: v })), onChange: (v) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), preMbdCount: v } } : r)), size: "small" })] })), angleSource === "preFA" && (_jsxs(Space, { size: 8, wrap: true, children: [_jsx(Text, { type: "secondary", children: "\uC804\uCC98\uB9AC FA \uCD1D \uAC1C\uC218" }), _jsx(Select, { style: { width: 160 }, value: preFaTotal, options: FULL_ANGLE_COUNTS.map(v => ({ label: v.toString(), value: v })), onChange: (v) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), preFaTotal: v } } : r)), size: "small" }), _jsxs(Tag, { color: "geekblue", children: ["\uD574\uC11D \uC774\uB984: ", analysisLabel({ ...row, params: { ...(row.params || {}), angleSource: "preFA" } })] })] })), (angleSource === "fromMBD" || angleSource === "fromFA") && (_jsxs(Space, { wrap: true, size: 8, children: [angleSource === "fromMBD" ? (_jsx(Select, { style: { width: 260 }, placeholder: "\uC704(\uC774\uC804) MBD \uC2DC\uB098\uB9AC\uC624 \uC120\uD0DD", value: angleSourceId || undefined, options: priorMbdOptions(row), onChange: (v) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), angleSourceId: v } } : r)), disabled: priorMbdOptions(row).length === 0, size: "small", dropdownMatchSelectWidth: false })) : (_jsx(Select, { style: { width: 260 }, placeholder: "\uC704(\uC774\uC804) FA \uC2DC\uB098\uB9AC\uC624 \uC120\uD0DD", value: angleSourceId || undefined, options: priorFaOptions(row), onChange: (v) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), angleSourceId: v } } : r)), disabled: priorFaOptions(row).length === 0, size: "small", dropdownMatchSelectWidth: false })), _jsx(Upload, { ...makeAnglesUploadProps(row), children: _jsx(Button, { size: "small", icon: _jsx(UploadOutlined, {}), children: "\uAC01\uB3C4 \uD30C\uC77C(.json/.csv)" }) }), angleSourceFileName && _jsx(Tag, { color: "geekblue", children: angleSourceFileName }), angleSource === "fromFA" && (_jsx(Tag, { color: "purple", children: "\uD45C\uC2DC\uBA85: \uC804\uAC01\uB3C4 \uB204\uC801 \uB099\uD558" }))] })), _jsx(Tag, { children: analysisLabel(row) })] }));
        }
        // ---- partialImpact ----
        ...
        return (_jsxs(Flex, { gap: 12, align: "center", wrap: true, style: { alignItems: "flex-start" }, children: [_jsxs(Radio.Group, { size: "small", value: mode, onChange: (e) => setScenarios(prev => prev.map(r => r.id === row.id ? { ...r, params: { ...(r.params || {}), piMode: e.target.value } } : r)), children: [_jsx(Radio, { value: "default", children: "default (\uC790\uB3D9 \uC120\uD0DD)" }), _jsx(Radio, { value: "txt", children: "txt \uC5C5\uB85C\uB4DC (\uD328\uD0A4\uC9C0 \uC774\uB984)" })] }), fileName && _jsx(Tag, { color: "geekblue", children: fileName })] }));
    };
        ...
        },
        {
            ...
            render: (_, row) => (_jsx(Select, { style: { width: "100%" }, size: "small", value: row.analysisType, onChange: (v) => {
                    setScenarios((prev) => prev.map((r) => (r.id === row.id ? {
                        ...r,
                        analysisType: v,
                        params: v === "fullAngleMBD" ? { mbdCount: 1000, angleSource: "lhs", heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" } :
                            v === "fullAngle" ? { faTotal: 100, includeFace6: true, includeEdge12: true, includeCorner8: true, angleSource: "lhs", preMbdCount: 10000, preFaTotal: 100, heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" } :
                                v === "fullAngleCumulative" ? { cumRepeatCount: 3, cumDOECount: 5, cumDirectionsGrid: diverseDefaultGrid(3, 5), heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" } :
                                    { piMode: "default" },
                    } : r)));
    ...
    const handleAddEmpty = () => {
        setScenarios((prev) => ([
            ...prev,
            { id: uid("scn"), name: "새 시나리오", analysisType: "fullAngleMBD", params: { mbdCount: 1000, angleSource: "lhs", heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" } },
        ]));
    };
    ...
    const handleBulkSetType = () => {
        ...
        setScenarios((prev) => prev.map((r) => selectedRowKeys.includes(r.id) ? ({
            ...
            params: bulkType === "fullAngleMBD" ? { mbdCount: 1000, angleSource: "lhs", heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" } :
                bulkType === "fullAngle" ? { faTotal: 100, includeFace6: true, includeEdge12: true, includeCorner8: true, angleSource: "lhs", preMbdCount: 10000, preFaTotal: 100, heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" } :
                    bulkType === "fullAngleCumulative" ? { cumRepeatCount: 3, cumDOECount: 5, cumDirectionsGrid: diverseDefaultGrid(3, 5), heightMode: "const", heightConst: 1.0, heightMin: 0.5, heightMax: 1.5, surface: "steelPlate" } :
                        { piMode: "default" },
        }) : r));
